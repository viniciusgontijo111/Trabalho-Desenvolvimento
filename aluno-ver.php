                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="tipo_documento" required="">
                                            ...
                                            <option <?=($rs['tipo_documento'] == "Bilhete de identidade" ? "selected": ''); ?> value="Bilhete de identidade" >Identidade</option> 
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="local_de_emissao" required="">
                                            ...
                                            <option <?=($rs['local_de_emissao'] == "Chimoio" ? "selected": ''); ?> value="Chimoio" >PR</option> 
                                            <option <?=($rs['local_de_emissao'] == "Maputo" ? "selected": ''); ?> value="Maputo" >GO</option> 
                                            <option <?=($rs['local_de_emissao'] == "Matola" ? "selected": ''); ?> value="Matola" >MG</option> 
                                            <option <?=($rs['local_de_emissao'] == "Gaza" ? "selected": ''); ?> value="Gaza" >RJ</option>
                                            <option <?=($rs['local_de_emissao'] == "Inhambane" ? "selected": ''); ?> value="Inhambane" >MT</option> 
                                            <option <?=($rs['local_de_emissao'] == "Quelimane" ? "selected": ''); ?> value="Quelimane" >MS</option> 
                                            <option <?=($rs['local_de_emissao'] == "Tete" ? "selected": ''); ?> value="Tete" >TO</option> 
                                            <option <?=($rs['local_de_emissao'] == "Nampula" ? "selected": ''); ?> value="Nampula" >CE</option>
                                            <option <?=($rs['local_de_emissao'] == "Lichinga" ? "selected": ''); ?> value="Lichinga" >BH</option> 
                                            <option <?=($rs['local_de_emissao'] == "Pemba" ? "selected": ''); ?> value="Pemba" >SE</option>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                        ...
                                        <select class="input-xs form-control in" name="nacionalidade_aluno" required="">
                                            ...
                                            <option <?=($rs['nacionalidade_aluno'] == "Moçambicana" ? "selected": ''); ?> value="Moçambicana">Portuguesa</option>

                                            <option <?=($rs['nacionalidade_aluno'] == "Angolana" ? "selected": ''); ?> value="Angolana">Angolana</option>

                                            <option <?=($rs['nacionalidade_aluno'] == "Zimbabweana" ? "selected": ''); ?> value="Zimbabweana">North Americana</option>

                                            <option <?=($rs['nacionalidade_aluno'] == "Brasileira" ? "selected": ''); ?> value="Brasileira">Brasileira</option>

                                            <option <?=($rs['nacionalidade_aluno'] == "Sul Africana" ? "selected": ''); ?> value="Sul Africana">Argentina</option>
